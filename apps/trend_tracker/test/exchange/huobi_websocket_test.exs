defmodule TrendTracker.Exchange.Huobi.WebSocketTest do
  ...
  @contract "wss://dm.huobi.vn/ws"
  @contract_auth "wss://api.btcgateway.pro/notification"
  @access_key "0e68eee0-8876fb1b-2cf93442-hrf5gdfghe"
  @secret_key "c1ffca37-657b8ed3-5a3bf04f-68600"

  test "contract ping" do
    assert {:ok, _pid} = HuobiWebSocket.start_link(@contract, catch_binary: self())
  ...
  test "request symbol klines" do
    assert {:ok, pid} = HuobiWebSocket.start_link(@contract, catch_binary: self())
  ...
  test "contract auth ping" do
    assert {:ok, _pid} = HuobiWebSocket.start_link(@contract_auth, access_key: @access_key, secret_key: @secret_key, catch_binary: self())
