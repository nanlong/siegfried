...
config :siegfried, env: :dev

# Configure your database
config :siegfried, Siegfried.Repo,
  username: "postgres",
  password: "postgres",
  database: "siegfried_dev",
  hostname: "localhost",
...
config :siegfried_web, SiegfriedWeb.Endpoint,
  ...
  watchers: [
    node: [
      ...
      "development",
      "--watch-stdin",
      cd: Path.expand("../apps/siegfried_web/assets", __DIR__)
    ]
  ]
...
config :siegfried_web, SiegfriedWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/siegfried_web/{live,views}/.*(ex)$",
      ~r"lib/siegfried_web/templates/.*(eex)$"
    ]
  ]
